...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ru | 50 ms | 72.7% | 45.5% | 45.5% | 18.2% | 0.0% | 0.0% | 0.0% (n=11) | 466.7 ms | 0.2 ms | 19.6 ms | 11/32 * |
| ru | 100 ms | 81.8% | 54.5% | 45.5% | 18.2% | 0.0% | 0.0% | 9.1% (n=11) | 467.7 ms | 0.2 ms | 16.5 ms | 11/32 * |
| ru | 150 ms **(gate window)** | 72.7% | 45.5% | 36.4% | 18.2% | 0.0% | 0.0% | 9.1% (n=11) | 468.4 ms | 0.1 ms | 18.6 ms | 11/32 * |
| ru | 200 ms | 81.8% | 54.5% | 54.5% | 9.1% | 0.0% | 0.0% | 18.2% (n=11) | 467.8 ms | 0.2 ms | 18.8 ms | 11/32 * |
| ru | 250 ms | 90.9% | 90.9% | 81.8% | 54.5% | 0.0% | 0.0% | 9.1% (n=11) | 468.6 ms | 0.1 ms | 16.1 ms | 11/32 * |
| he | 50 ms | — | — | — | — | — | — | — | — | — | — | — |
| he | 100 ms | — | — | — | — | — | — | — | — | — | — | — |
...
- **FAIL** `ru` predictor Top-20 recall: actual=0.3438 >= 0.95
- **PASS** `ru` 150 ms acoustic samples: actual=32 >= 30.0
- **PASS** `ru` 150 ms pruner round-trip samples: actual=32 >= 30.0
- **FAIL** `ru` 150 ms conditional Top-5 retention: actual=0.4545 >= 0.95
- **FAIL** `ru` 150 ms conditional Top-3 retention: actual=0.3636 >= 0.88
- **FAIL** `ru` 150 ms Top-5 miss rate (vanished + errored + demoted below 5): actual=0.5455 <= 0.05
- **PASS** `ru` 150 ms cold-parallel lead positive rate: actual=1.0 >= 0.75
- **PASS** `ru` 150 ms cold-parallel lead p50: actual=468.4 >= 150.0
- **PASS** `ru` 150 ms pruner round-trip p95: actual=18.6 <= 220.0
